...
namespace SSharp.VM
{
    public class Interpreter
    {
        ...
        public bool LoadLibrary(string LibPath)
        {
            try
            {
                Assembly a = Assembly.LoadFrom(LibPath);

                Type libReferencer = a.GetType("SSLib.LibReferencer");
                object libRefInstance = a.CreateInstance("SSLib.LibReferencer");
                MethodInfo mi = libReferencer.GetMethod("GetLibraryName");
                string libPath = (string)mi.Invoke(libRefInstance, null);

                Type libMain = a.GetType(libPath);
                object instance = a.CreateInstance(libPath);
                MethodInfo mi2 = libMain.GetMethod("LoadLibrary");

                mi2.Invoke(instance, new object[] { this });

                LoadedLibraries.Add((VMLibrary)instance);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public VMObject InterpretExpression(ContainerToken container, Block scope)
        {
        ...
        public List<VMObject> InterpretFunctionArguments(Parentheses parentheses, Block scope)
        {
        ...
        public List<string> InterpretFunctionDefinitionArguments(Parentheses parentheses)
        {
        ...
        public VMObject InterpretBlock(Block block)
        {
        ...
        public VMObject InterpretFunction(VMFunction function, List<VMObject> arguments)
        {
        ...
        public VMObject InterpretScript(Script script)
        {
